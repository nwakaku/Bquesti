...
',Arial,sans-serif"><rect x="0" y="0" width="100%" height="100%" fill="#eee" rx="10%" /><g id="text" fill="black" font-size="80" font-weight="500" text-anchor="middle"><text x="50%" y="40%" font-weight="700">BQuesti</text><text x="50%" y="65%">Bquesti</text><text x="90%" y="90%" font-size="36" text-anchor="end">';
    ...
    function tokenURI(
        ...
        string memory o = string(
            abi.encodePacked(
                ...
                '","symbol":"',
                _symbol,
                '","description":"Bquesti: Your on-chain will","image": "data:image/svg+xml;base64,',
